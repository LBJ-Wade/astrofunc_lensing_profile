...
class SPEP_SIS(object):
    ...
    def derivatives(self, x, y, phi_E, gamma, q, phi_G, center_x, center_y, phi_E_sis, center_x_sis, center_y_sis):
    ...
    def hessian(self, x, y, phi_E, gamma, q, phi_G, center_x, center_y, phi_E_sis, center_x_sis, center_y_sis):
    ...
    def all(self, x, y, phi_E, gamma, q, phi_G, center_x, center_y, phi_E_sis, center_x_sis, center_y_sis):
