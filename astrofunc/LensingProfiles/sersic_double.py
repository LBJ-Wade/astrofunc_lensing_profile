...
class SersicDouble(object):
    ...
    def function(self, x, y, k_eff, flux_ratio, r_eff, n_sersic, phi_G, q, R_2, n_2, center_x=0, center_y=0):
        """
        returns Gaussian
        """
        k_eff2 = k_eff * flux_ratio
        f_1 = self.sersic.function(x, y, n_sersic, r_eff, k_eff, q, phi_G, center_x, center_y)
        f_2 = self.sersic.function(x, y, n_2, R_2, k_eff2, q, phi_G, center_x, center_y)
        return f_1 + f_2

    def derivatives(self, x, y, k_eff, flux_ratio, r_eff, n_sersic, phi_G, q, R_2, n_2, center_x=0, center_y=0):
        """
        returns df/dx and df/dy of the function
        """
        k_eff2 = k_eff * flux_ratio
        f_x1, f_y1 = self.sersic.derivatives(x, y, n_sersic, r_eff, k_eff, q, phi_G, center_x, center_y)
        f_x2, f_y2 = self.sersic.derivatives(x, y, n_2, R_2, k_eff2, q, phi_G, center_x, center_y)
        return f_x1 + f_x2, f_y1 + f_y2

    def hessian(self, x, y, k_eff, flux_ratio, r_eff, n_sersic, phi_G, q, R_2, n_2, center_x=0, center_y=0):
        """
