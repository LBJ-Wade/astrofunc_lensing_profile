...
class SPEP_NFW(object):
    ...
    def function(self, x, y, theta_E, gamma, q, phi_G, center_x, center_y, Rs, rho0, r200, center_x_nfw, center_y_nfw):
    ...
    def derivatives(self, x, y, theta_E, gamma, q, phi_G, center_x, center_y, Rs, rho0, r200, center_x_nfw, center_y_nfw):
    ...
    def hessian(self, x, y, theta_E, gamma, q, phi_G, center_x, center_y, Rs, rho0, r200, center_x_nfw, center_y_nfw):
    ...
    def all(self, x, y, theta_E, gamma, q, phi_G, center_x, center_y, Rs, rho0, r200, center_x_nfw, center_y_nfw):
